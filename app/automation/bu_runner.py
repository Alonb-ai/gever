...
- מפת המושבים היא לרוב SVG: קליק שלא נתפס — אל תנחש selectors בניסיונות עיוורים;
  ...
  משמש למדידה בלבד: שלוף getBoundingClientRect של אלמנטי המושבים (בדוק גם use/symbol
  — לפעמים המושבים מיוצגים כך), ואז בצע click עם coordinate_x/coordinate_y על מרכז
  ה-bbox שנמדד — לא על ניחוש מצילום המסך. זום או גלילה מזיזים הכל — מדוד מחדש
  מיד לפני הקליק.
