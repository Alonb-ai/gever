...
# --- בלוקים משותפים לשני ה-builders (מסעדה/קולנוע) — נוסח אחד, מילה במילה ---
...
- בחר הקרנה בתאריך המבוקש, הקרובה ביותר לשעה המבוקשת — עד 90 דקות סטייה לכל
  היותר (קדימה או אחורה). אין הקרנה בטווח, או שאזלו הכרטיסים → FAILED:no_availability.
...
ואין לך אותו — אל תמלא ואל תמציא; עצור מיד וסיים את הדיווח במילה MISSING ואחריה
שם השדה, תמיד באנגלית: MISSING:name / MISSING:last_name / MISSING:email /
MISSING:phone. אותו כלל לכל בחירה אחרת שהאתר כופה ולא קיבלת עליה העדפה (מלבד
