...
# דפי show/event חיים בקופת ("לרכישת כרטיסים") ובלאן ("רכישת כרטיסים") מציגים
# כפתור רכישה; דף הרפאים — אפס מופעים. "הזמנת כרטיסים" נפסל כמרקר: הוא יושב
# ב-<title>/og:title של דף הרפאים עצמו ("הזמנת כרטיסים ישירה...") — false-alive
# שנתפס באימות החי של הסבב.
_EVENT_ALIVE_MARKS = ("רכישת כרטיסים", "בחירת מושבים")
