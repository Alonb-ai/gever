...
- ✅ מומש (2026-07-03) — כל השרשרת: keepAlive, שמירת סשן על MISSING, resume מאותו מסך, שחרור על כל תוצאה סופית/timeout, fallback לסשן מת + החלפת מסעדה. tests/test_pause_resume.py.
